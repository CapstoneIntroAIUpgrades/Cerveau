 ...
 */
export class ConnectFourGame extends BaseClasses.Game {
    /** The manager of this game, that controls everything around it. */
    public readonly manager!: ConnectFourGameManager;
     ...
     */
    constructor(
        protected settingsManager: ConnectFourGameSettingsManager,
