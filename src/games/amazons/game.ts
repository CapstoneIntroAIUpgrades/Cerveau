 ...
 */
export class AmazonsGame extends BaseClasses.Game {
    /** The manager of this game, that controls everything around it. */
    public readonly manager!: AmazonsGameManager;
     ...
     */
    constructor(
        protected settingsManager: AmazonsGameSettingsManager,
        required: Readonly<BaseGameRequiredData>,
    ) {
        super(settingsManager, required);

        // <<-- Creer-Merge: constructor -->>
        (this.players[0] as MutablePlayer).piece = "Q";
        (this.players[1] as MutablePlayer).piece = "q";
        // <<-- /Creer-Merge: constructor -->>
    }
