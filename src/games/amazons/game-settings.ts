...
/**
 * The settings manager for the Amazons game.
 */
export class AmazonsGameSettingsManager extends BaseClasses.GameSettings {
    /**
    ...
    public get schema() {
        return this.makeSchema({
            ...
            // Amazons game specific settings
            // <<-- Creer-Merge: schema -->>
     ...
     */
    public values!: SettingsFromSchema<AmazonsGameSettingsManager["schema"]>;
