...
/**
 * The settings manager for the UltimateTicTacToe game.
 */
export class UltimateTicTacToeGameSettingsManager extends BaseClasses.GameSettings {
    /**
    ...
    public values!: SettingsFromSchema<
        UltimateTicTacToeGameSettingsManager["schema"]
    >;
